 ...
 <%@include file="includes/aside.jsp" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Payer les frais d'activation du compte
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Payer le frais d'activation du compte</a></li>
      </ol>
    </section>
          ...
          <div class="box" style="overflow: auto;">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="control-label">Montant d'activation<span style="color: red;"> (20$)</span></label>
