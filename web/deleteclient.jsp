...
<%
    ...
    try{
       ...
       PreparedStatement ps = conn.prepareStatement("DELETE FROM t_client WHERE CodeClient=?");
       ps.setString(1, id);
    ...
    <section class="content">
      <div class="row">
        ...
        while(rs.next())
                                {
                                    %>
                <h2 style="color: red;">Supprimer <%=rs.getString("NomClient")+' '+rs.getString("PostnomClient")+' '+rs.getString("PrenomClient")%> ?</h2>                   
