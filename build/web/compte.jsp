            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                                ...
                                String query = ("SELECT * FROM t_compte INNER JOIN t_categorie_compte ON t_compte.CodeCategorie=t_categorie_compte.CodeCategorie INNER JOIN t_client ON t_compte.CodeClient=t_client.CodeClient");
                                Statement st = conn3.createStatement();
                                rs = st.executeQuery(query);
                                while(rs.next())
                                {
                                    String id = rs.getString("CodeCompte");
                                    ...
                                    if(solde>20)
                                    {
                                        ...
                                        <tr>
                                                    ...
                                                    <td>
                                                        <a href='compteclient.jsp?id=<%=id %>' class='btn btn-primary btn-sm btn-flat'><i class='fa fa-plus'>Voir</i></a>
                                                    </td>
                                                </tr>
                                        <%
                                    }else if(solde<20)
