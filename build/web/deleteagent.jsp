...
<%
    ...
    try{
       ...
       PreparedStatement ps = conn.prepareStatement("DELETE FROM t_agent WHERE CodeAgent=?");
       ps.setString(1, id);
    ...
    <section class="content">
      <div class="row">
        ...
        while(rs.next())
                                {
                                    %>
                <h2 style="color: red;">Supprimer <%=rs.getString("NomAgent")+' '+rs.getString("PostnomAgent")+' '+rs.getString("PrenomAgent")%> ?</h2>                   
